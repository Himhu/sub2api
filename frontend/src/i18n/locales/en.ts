export default {
  ...
  keys: {
    ...
    modelsSourceMapping: 'Whitelist models',
    ...
    modelsAllPaused: 'Service unavailable',
    modelsAllPausedDesc: 'All routes in this group are temporarily unavailable, please contact administrator',
    modelsLoading: 'Loading models...',
    modelsEmpty: 'No models available for this group',
    modelsLoadFailed: 'Failed to load models',
    modelsRetry: 'Retry',
    clickToCopyModel: 'Click to copy model name',
  ...
  promotion: {
    ...
    agentNoInviterReward: 'Agents earn through commission sharing',
    forNewUser: 'for new user registration',
  ...
  agentCenter: {
    title: 'Agent Center',
    description: 'Manage your downline users and invite statistics',
    // Become agent related
    becomeAgent: 'Become an Agent',
    becomeAgentDesc: 'Join our agent program and earn more rewards',
    step1Title: 'Contact Admin',
    step1Desc: 'Contact the administrator through official channels to apply',
    step2Title: 'Wait for Review',
    step2Desc: 'The administrator will review your application and grant agent permissions',
    step3Title: 'Start Promoting',
    step3Desc: 'Once approved, you can view downline data and earn commissions',
    contactAdmin: 'To become an agent, please contact the administrator to enable agent permissions.',
    // Agent data related
    totalInvited: 'Total Invited',
    directInvited: 'Direct Invited',
    invitedAgents: 'Invited Agents',
    invitedUsers: 'Invited Users',
    downlineUsers: 'Downline Users',
    noDownline: 'No downline users yet',
    statusAgent: 'Agent',
    statusUser: 'User',
    columns: {
      email: 'Email',
  ...
  admin: {
    ...
    users: {
      ...
      deposit: 'Deposit',
      withdraw: 'Withdraw',
      upgradeToAgent: 'Upgrade to Agent',
      upgradeToAgentConfirm: 'Are you sure you want to upgrade user {email} to an agent?',
    ...
    agents: {
      ...
      createFirstAgent: 'Set a user as agent to start.',
      columns: {
        email: 'Email',
        username: 'Username',
      ...
      statusAgent: 'Agent',
      statusUser: 'User',
      viewDownline: 'View Downline',
      viewStats: 'View Stats',
      setAsAgent: 'Set as Agent',
      removeAgent: 'Remove Agent',
      downlineTitle: 'Downline Users',
      statsTitle: 'Invite Statistics',
      totalInvited: 'Total Invited',
      invitedAgents: 'Invited Agents',
      invitedUsers: 'Invited Users',
      directInvited: 'Direct Invited',
      ...
      columnSettings: 'Column Settings',
      setAgent: 'Set Agent',
      setAgentTitle: 'Set Agent',
      selectUser: 'Select User',
      searchUserPlaceholder: 'Search user email...',
      confirmSetAgent: 'Set as Agent',
      agentSet: 'Successfully set as agent',
      agentRemoved: 'Agent status removed',
      failedToSetAgent: 'Failed to set agent',
      revokeAgent: 'Revoke Agent',
      revokeAgentConfirm: 'Are you sure you want to revoke agent status for {email}? Downline users will be transferred to the parent agent.',
      revokeAgentSuccess: 'Agent status revoked successfully',
