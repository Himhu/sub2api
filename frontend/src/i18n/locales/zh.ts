export default {
  ...
  keys: {
    ...
    modelsAllPaused: '线路故障',
    modelsAllPausedDesc: '该分组的所有线路暂时不可用，请联系管理员',
    modelsLoading: '加载模型中...',
    modelsEmpty: '该分组暂无可用模型',
    modelsLoadFailed: '加载模型失败',
    modelsRetry: '重试',
    clickToCopyModel: '点击复制模型名称',
    modelCopied: '模型名称已复制',
    statusLabel: '状态',
    selectStatus: '选择状态',
    saving: '保存中...',
  ...
  promotion: {
    ...
    perInvite: '每成功邀请一人',
    agentNoInviterReward: '代理通过佣金分成获得收益',
    forNewUser: '新用户注册即得',
    becomeAgent: '成为代理',
    agentBenefits: '代理权益',
  ...
  agentCenter: {
    title: '代理中心',
    description: '管理您的下线用户和邀请统计',
    // 成为代理相关
    becomeAgent: '成为代理',
    becomeAgentDesc: '加入我们的代理计划，获得更多收益',
    step1Title: '联系管理员',
    step1Desc: '通过官方渠道联系管理员申请成为代理',
    step2Title: '等待审核',
    step2Desc: '管理员会审核您的申请并开通代理权限',
    step3Title: '开始推广',
    step3Desc: '获得代理权限后，您可以查看下线数据并获得返利',
    contactAdmin: '如需成为代理，请联系管理员开通代理权限。',
    // 代理数据相关
    totalInvited: '总邀请人数',
    directInvited: '直接邀请',
    invitedAgents: '邀请代理数',
  ...
  admin: {
    ...
    users: {
      ...
      deposit: '充值',
      withdraw: '退款',
      upgradeToAgent: '升级为代理',
      upgradeToAgentConfirm: '确定要将用户 {email} 升级为代理吗？',
    ...
    agents: {
      ...
      confirmSetAgent: '设为代理',
      agentSet: '已成功设置为代理',
      agentRemoved: '已取消代理身份',
      failedToSetAgent: '设置代理失败',
      revokeAgent: '取消代理',
      revokeAgentConfirm: '确定要取消用户 {email} 的代理身份吗？下属用户将被转移给上级代理。',
      revokeAgentSuccess: '已成功取消代理身份',
