...
func (_u *UserUpdate) SetPoints(v float64) *UserUpdate {
...
func (_u *UserUpdate) SetNillablePoints(v *float64) *UserUpdate {
	if v != nil {
		_u.SetPoints(*v)
	}
	return _u
...
func (_u *UserUpdate) AddPoints(v float64) *UserUpdate {
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedPoints(); ok {
		_spec.AddField(user.FieldPoints, field.TypeFloat64, value)
	}
...
// SetPoints sets the "points" field.
func (_u *UserUpdateOne) SetPoints(v float64) *UserUpdateOne {
	_u.mutation.ResetPoints()
	_u.mutation.SetPoints(v)
	return _u
}
...
// SetNillablePoints sets the "points" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillablePoints(v *float64) *UserUpdateOne {
	if v != nil {
		_u.SetPoints(*v)
	}
	return _u
...
// AddPoints adds value to the "points" field.
func (_u *UserUpdateOne) AddPoints(v float64) *UserUpdateOne {
	_u.mutation.AddPoints(v)
	return _u
}
